...
This directory will contain worked DPIP interaction profiles and, as the project matures, their machine-readable and executable conformance evidence.

The initial examples will cover:

1. privacy-preserving personhood presentation;
2. privacy-preserving relationship proof;
3. cross-community asymmetric relationship proof.
